...
object Catalog {
    ...
    val models: List<ModelEntry> = listOf(
        ...
        ModelEntry(
            ...
            sizeLabel = "1.0 GB", speedHint = "very fast",
            fileBytes = gb(0.97), minRamMb = 2000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            sizeLabel = "1.0 GB", speedHint = "very fast",
            fileBytes = gb(1.0), minRamMb = 2000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            fileBytes = gb(1.4), minRamMb = 2500, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            colorStart = 0xFFF5C77B, colorEnd = 0xFFD08A34,
            sizeLabel = "2.0 GB", speedHint = "fast",
            fileBytes = gb(2.02), minRamMb = 4000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            sizeLabel = "2.4 GB", speedHint = "fast",
            fileBytes = gb(2.4), minRamMb = 4500, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            colorStart = 0xFF7BD4F5, colorEnd = 0xFF3C8FD0,
            sizeLabel = "2.5 GB", speedHint = "fast",
            fileBytes = gb(2.5), minRamMb = 5000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            colorStart = 0xFF9BE7C4, colorEnd = 0xFF3FA47C,
            sizeLabel = "2.6 GB", speedHint = "fast",
            fileBytes = gb(2.6), minRamMb = 5000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            fileBytes = gb(4.37), minRamMb = 7000, ctxDefault = 4096,
            arch = "llama", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            fileBytes = gb(4.68), minRamMb = 7500, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            sizeLabel = "4.7 GB", speedHint = "steady",
            fileBytes = gb(4.68), minRamMb = 7500, ctxDefault = 8192,
            arch = "qwen2", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFFF5C77B, colorEnd = 0xFFD08A34,
            sizeLabel = "4.9 GB", speedHint = "steady",
            fileBytes = gb(4.92), minRamMb = 8000, ctxDefault = 4096,
            arch = "llama", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFF7BD4F5, colorEnd = 0xFF3C8FD0,
            sizeLabel = "5.0 GB", speedHint = "steady",
            fileBytes = gb(5.03), minRamMb = 8000, ctxDefault = 4096,
            arch = "qwen3", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFF9BE7C4, colorEnd = 0xFF3FA47C,
            sizeLabel = "7.3 GB", speedHint = "slow",
            fileBytes = gb(7.3), minRamMb = 11000, ctxDefault = 4096,
            arch = "gemma3", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFF7BD4F5, colorEnd = 0xFF3C8FD0,
            sizeLabel = "9.0 GB", speedHint = "slow",
            fileBytes = gb(8.99), minRamMb = 13000, ctxDefault = 4096,
            arch = "qwen3", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFFF6A5A5, colorEnd = 0xFFCE5757,
            sizeLabel = "9.1 GB", speedHint = "slow",
            fileBytes = gb(9.05), minRamMb = 13000, ctxDefault = 4096,
            arch = "phi3", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            sizeLabel = "12 GB", speedHint = "very slow",
            fileBytes = gb(11.9), minRamMb = 17000, ctxDefault = 4096,
        ...
        ModelEntry(
            ...
            colorStart = 0xFF9BE7C4, colorEnd = 0xFF3FA47C,
            sizeLabel = "16.4 GB", speedHint = "very slow",
            fileBytes = gb(16.4), minRamMb = 22000, ctxDefault = 4096,
            arch = "gemma3", quant = "Q4_K_M",
        ...
        ModelEntry(
            ...
            colorStart = 0xFF7BD4F5, colorEnd = 0xFF3C8FD0,
            sizeLabel = "19.5 GB", speedHint = "very slow",
            fileBytes = gb(19.5), minRamMb = 26000, ctxDefault = 4096,
            arch = "qwen3", quant = "Q4_K_M",
